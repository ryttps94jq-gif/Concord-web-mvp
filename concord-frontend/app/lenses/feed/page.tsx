...
const DEMO_POSTS: FeedPost[] = [
  {
    id: 'p1', type: 'audio', author: DEMO_AUTHORS[0],
  ...
  {
    id: 'p2', type: 'release', author: DEMO_AUTHORS[1],
  ...
  {
    id: 'p3', type: 'text', author: DEMO_AUTHORS[2],
  ...
  {
    id: 'p4', type: 'art', author: DEMO_AUTHORS[4],
  ...
  {
    id: 'p5', type: 'collab', author: DEMO_AUTHORS[3],
  ...
  {
    id: 'p6', type: 'audio', author: DEMO_AUTHORS[5],
  ...
  {
    id: 'p7', type: 'text', author: DEMO_AUTHORS[6],
  ...
  {
    id: 'p8', type: 'release', author: DEMO_AUTHORS[7],
  ...
  {
    id: 'p9', type: 'audio', author: DEMO_AUTHORS[8],
  ...
  {
    id: 'p10', type: 'art', author: DEMO_AUTHORS[9],
  ...
  {
    id: 'p11', type: 'collab', author: DEMO_AUTHORS[0],
  ...
  {
    id: 'p12', type: 'text', author: DEMO_AUTHORS[4],
  ...
  {
    id: 'p13', type: 'audio', author: DEMO_AUTHORS[1],
  ...
  {
    id: 'p14', type: 'text', author: DEMO_AUTHORS[5],
  ...
  {
    id: 'p15', type: 'release', author: DEMO_AUTHORS[8],
  ...
  {
    id: 'p16', type: 'collab', author: DEMO_AUTHORS[7],
  ...
  {
    id: 'p17', type: 'audio', author: DEMO_AUTHORS[3],
  ...
  const { data: feedPosts, isLoading } = useQuery<FeedPost[]>({
    ...
    queryFn: async () => {
      try {
        ...
        return serverPosts.length > 0 ? serverPosts : DEMO_POSTS;
      } catch {
        return DEMO_POSTS;
      }
    },
